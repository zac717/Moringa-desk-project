...
Notification.create(user_id: user_ids.sample, target_id: question1.id, target_type: "Question", type:"NewQuestion" )
Notification.create(user_id: user_ids.sample, target_id: answer2a.id, target_type: "Answer", type: "Suggestion")
